...
def select_trimming(video_dict: Dict[str, Dict], parent_tk_instance=None):
    ...
    # Make dialog modal
    # Check if dialog_parent is not the temp_root (meaning a real parent was passed)
    # OR if dialog_parent IS the temp_root AND temp_root is not None (meaning it was created)
